...
refund_fastpay_by_platform_pwd_php_utf8
  │
  ├lib┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  ...
  │
  ├refund_fastpay_by_platform_pwd.php ┈┈┈支付宝接口入口文件
  │
  ├index.php┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈支付宝调试入口页面
  │
...
※注意※
需要配置的文件是：alipay.config.php、refund_fastpay_by_platform_pwd.php、notify_url.php
...
function refund_fastpay_by_platform_pwd($para_temp)
功能：构造即时到账批量退款有密接口
