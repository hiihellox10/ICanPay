<%@ Page language="c#" Codebehind="queryresult.aspx.cs" AutoEventWireup="false" Inherits="tenpaymd5.queryresult" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>查询结果处理页面</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 5%; POSITION: absolute; TOP: 5%" cellSpacing="1"
				...
				<TR>
					<TD align="center" colSpan="2"><asp:label id="Label1" runat="server" ForeColor="Blue">查询结果如下所示</asp:label></TD>
				</TR>
				<TR>
