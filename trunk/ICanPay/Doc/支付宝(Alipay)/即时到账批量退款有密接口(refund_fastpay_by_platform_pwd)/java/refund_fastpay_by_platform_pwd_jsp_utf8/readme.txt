  ...
  │        ╰───────────────────────╯                  │
　│                                                                            │
　│     接口名称：即时到帐批量退款有密接口（refund_fastpay_by_platform_pwd）   │
　│　   代码版本：3.2                                                          │
  │     开发语言：JAVA                                                         │
  │     版    权：支付宝（中国）网络技术有限公司                               │
　│     制 作 者：支付宝商户事业部技术支持组                                   │
...
refund_fastpay_by_platform_pwd_jsp_utf8
  │
  ├src┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  │  ├com.alipay.config
  ...
  ├WebRoot┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈页面文件夹
  │  │
  │  ├refund_fastpay_by_platform_pwd.jsp ┈┈┈┈┈支付宝接口入口文件
  │  │
  │  ├index.jsp┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈支付宝调试入口页面
  │  │
...
需要配置的文件是：
alipay_config.jsp、
index.jsp、refund_fastpay_by_platform_pwd.jsp、
notify_url.jsp、
