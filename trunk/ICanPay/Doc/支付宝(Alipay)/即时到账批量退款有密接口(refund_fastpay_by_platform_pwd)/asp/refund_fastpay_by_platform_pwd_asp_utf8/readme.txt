...
refund_fastpay_by_platform_pwd_asp_utf8
  │
  ├class┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  ...
  ├log┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈日志文件夹
  │
  ├refund_fastpay_by_platform_pwd.asp ┈┈┈┈支付宝接口入口文件
  │
  ├index.asp┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈支付宝调试入口页面
  │
...
※注意※
需要配置的文件是：alipay_config.asp、refund_fastpay_by_platform_pwd.asp、notify_url.asp
...
Public Function Refund_fastpay_by_platform_pwd(sParaTemp)
功能：构造即时到账批量退款有密接口
