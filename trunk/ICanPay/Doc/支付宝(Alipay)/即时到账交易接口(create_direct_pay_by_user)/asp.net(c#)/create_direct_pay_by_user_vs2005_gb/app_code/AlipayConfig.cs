...
namespace Com.Alipay
{
    ...
    internal class Config
    {
        ...
        static Config()
        {
            ...
            return_url = "http://127.0.0.1:48316/create_direct_pay_by_user_vs2005_gb/return_url.aspx";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://www.xxx.com/create_direct_pay_by_user_vs2005_gb/notify_url.aspx";
